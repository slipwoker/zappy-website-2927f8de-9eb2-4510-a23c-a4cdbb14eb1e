document.addEventListener('DOMContentLoaded', function () {
  ...
  if (navbar) {
    ...
    // Run on init in case page loads already scrolled
    handleNavbarScroll();
  }
  ...
  // Auto-register elements with data-animate attribute or existing fade-in-element class
  ...
  if (staggerContainers.length > 0 && 'IntersectionObserver' in window) {
    ...
    staggerContainers.forEach(function (container) {
      Array.from(container.children).forEach(function (child) {
        child.classList.add(OBSERVED_CLASS);
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2927f8de-9eb2-4510-a23c-a4cdbb14eb1e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2927f8de-9eb2-4510-a23c-a4cdbb14eb1e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2927f8de-9eb2-4510-a23c-a4cdbb14eb1e';
